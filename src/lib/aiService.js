...
export async function generateAIResponse(question) {
  try {
        ...
        contents: [
          {
            ...
            parts: [{ text: `You are an AI with humor and sarcasm with correct facts. Follow these rules:\n
                ...
                3. Always respond in English text, but adapt the language:\n
                   - If the user types in Nepali, reply in Nepali but using English script.\n
                4. Be friendly and adapt their messaging tone (style) and reply them and helpful to everyone.\n
    ...
    return 'I am sorry, but I encountered an error processing your question. Please try again later.';
  }
}
